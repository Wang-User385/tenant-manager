...
public class PPMT extends NumericFunction {
	...
	public double eval(ValueEval[] args, int srcCellRow, int srcCellCol) throws EvaluationException {
		...
		ValueEval v5 = OperandResolver.getSingleValue(args[4], srcCellRow, srcCellCol);
		ValueEval v6 = OperandResolver.getSingleValue(args[5], srcCellRow, srcCellCol);
		...
		result = HlsFinance.ppmt(interestRate, period, numberPayments, PV,FV,type) ;
