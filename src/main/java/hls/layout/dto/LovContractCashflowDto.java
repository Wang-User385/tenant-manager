...
public class LovContractCashflowDto {
    ...
    @LovField(prompt = "租金支付表编号", field = "contract_number", forDisplay = true, forQuery = true, displayWidth = 120, displayAlign = "left")
    ...
    @LovField(prompt = "法务合同编号", field = "legal_contract_number", forDisplay = true, forQuery = true, displayWidth = 120, displayAlign = "left")
    private String legalContractNumber;
    @LovField(prompt = "期数", field = "times", forDisplay = true, displayWidth = 60)
    private Long times;
    @LovField(prompt = "预定收款日期", field = "dueDateFormat")
    ...
    @LovField(prompt = "预定收款金额", field = "due_amount", forDisplay = true, displayWidth = 130)
