...
public class EASLoginProxyServiceLocator extends org.apache.axis.client.Service implements EASLoginProxyService {
    ...
    private String EASLogin_address = "http://168.6.101.28:6888/ormrpc/services/EASLogin";
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://168.6.101.28:6888/ormrpc/services/EASLogin", "EASLoginProxyService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://168.6.101.28:6888/ormrpc/services/EASLogin", "EASLogin"));
        }
