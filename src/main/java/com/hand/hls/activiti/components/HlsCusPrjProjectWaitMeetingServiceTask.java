...
public class HlsCusPrjProjectWaitMeetingServiceTask implements JavaDelegate, IActivitiBean {
    @Autowired
    ...
    public HlsCusPrjProjectWaitMeetingServiceTask(){}
    @Override
    public void execute(DelegateExecution delegateExecution) {
        ...
        if(hlsCusPrjProject.getProjectId() != null){
            hlsCusPrjProject.setApprovalStatus("MEETING");
            hlsCusPrjProject.setProcessInstanceId(Long.parseLong(delegateExecution.getProcessInstanceId()));
