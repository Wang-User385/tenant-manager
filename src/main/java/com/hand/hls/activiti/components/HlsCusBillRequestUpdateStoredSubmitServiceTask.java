...
public class HlsCusBillRequestUpdateStoredSubmitServiceTask implements JavaDelegate, IActivitiBean {
    @Autowired
    private hlsBillRequestMapper hlsBillRequestMapper;
    @Autowired
    private IhlsBillRequestService hlsBillRequestService;
    public HlsCusBillRequestUpdateStoredSubmitServiceTask() {
    }
    ...
    public void execute(DelegateExecution delegateExecution) {
        ...
        if ("APPROVED".equalsIgnoreCase(result)) {
            hlsBillRequest.setBillStatus("STORED");
