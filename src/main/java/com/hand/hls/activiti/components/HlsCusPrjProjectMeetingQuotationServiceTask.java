...
public class HlsCusPrjProjectMeetingQuotationServiceTask implements JavaDelegate, IActivitiBean {
    @Autowired
    ...
    public HlsCusPrjProjectMeetingQuotationServiceTask(){}
    @Override
    public void execute(DelegateExecution delegateExecution) {
        ...
        prjProjectOld.setProjectId(projectId);
        prjProjectOld = hlsCusPrjProjectMapper.selectByPrimaryKey(prjProjectOld);
            ...
            if(versionFlag.equals("N")){
                ...
                prjProject.setProjectId(prjProjectOld.getProjectId());
                ...
                for(HlsCusPrjQuotation dt:hlsCusPrjQuotationList){
                    ...
                    hlsCusPrjQuotationHistory.setSourceDocumentId(prjProjectOld.getProjectId());

                    hlsCusPrjQuotationHistory.setChangeCategory("PRJ_MEETING_REVIEW");
