...
public class HlsCusPrjProjectChangeEndServiceTask implements JavaDelegate, IActivitiBean {
    @Autowired
    ...
    public HlsCusPrjProjectChangeEndServiceTask(){}
    @Override
    public void execute(DelegateExecution delegateExecution) {
        ...
        String hlsCusPrjProjectNewStr = (String) delegateExecution.getVariable("hlsCusPrjProjectNew");
        HlsCusPrjProject hlsCusPrjProjectNew = JSON.parseObject(hlsCusPrjProjectNewStr, HlsCusPrjProject.class);
        ...
        if("APPROVED".equalsIgnoreCase(result) || "REJECTED".equalsIgnoreCase(result) || "SUSPEND".equalsIgnoreCase(result) || "REVIEW".equalsIgnoreCase(result)){
            if(versionFlag.equals("N")){
                ...
                prjProject.setProjectId(hlsCusPrjProjectNew.getProjectId());
                ...
                for(HlsCusPrjQuotation dt:hlsCusPrjQuotationList){
                    ...
                    hlsCusPrjQuotationHistory.setChangeCategory("PRJ_BEFORE_NOTICE_CHANGE");
