...
public class YLInterfaceServiceImpl implements YLInterfaceService {
    ...
    public String placeOrder(String decryptedStr,IRequest iRequest) throws HlsCusException {
        ...
        hlsCusPrjProject.setCompenDay(hlsProductDefinitionList.get(0).getCompenDay());
        hlsCusPrjProject.setBuyBackDay(hlsProductDefinitionList.get(0).getBuyBackDay());
        hlsCusPrjProject.setPenaltyRate(hlsProductDefinitionList.get(0).getPenaltyRate());
    ...
    public String closeOrder(String decryptedStr) throws HlsCusException {
        ...
        if(hlsCusPrjProject.getOrderStatus().equals("CLOSED")){
            returnJson.put("code","100101");
        ...
        if(hlsCusPrjProject.getOrderStatus().equals("INCEPT")){
            returnJson.put("code","100101");
            returnJson.put("message","合同已起租，不允许此操作");
            throw new HlsCusException(returnJson.toJSONString());
        }
