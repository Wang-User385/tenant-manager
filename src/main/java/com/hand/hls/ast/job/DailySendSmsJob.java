 ...
 */
@Component
public class DailySendSmsJob extends AbstractJobWithIRequest {
    public static final String TEMPLATE_CODE = "RENTAL";
    ...
    public void safeExecuteWithIRequest(JobExecutionContext var1, IRequest var2) throws Exception {
        try {
            ...
            for (MessageRule messageRule : messageRules) {
                List<HlsCusConContractCashflow> cashflowList = cashflowMapper.querySmsCashflowList((int) (long) messageRule.getRuleN3(), messageRule.getRuleV2(), messageRule.getRuleV1());
