...
@Controller
@RequestMapping(value = "/hls/doc/layout/lov")
public class DocLayoutLovController extends BaseController {
    ...
    public ResponseData queryForLov(@ModelAttribute(LEAF_PARAM_NAME) LeafRequestData requestData,
        ...
        parameter.forEach(param::put);
        List<LovDocLayoutDto> list = docLayoutService.selectForLov(param, pageNum, pageSize);
