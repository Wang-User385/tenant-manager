...
public class HlsCusRiskWarningAddMinitorJob extends AbstractJobWithIRequest {
    @Autowired
    ...
    public void adMinitor(String domainNames) throws UnsupportedEncodingException {
        ...
        try {
            ...
            if(response.getStatusLine().getStatusCode()==200){
                ...
                jcTianyanchaInterfaceInfo.setCreatedBy(-1L);
                jcTianyanchaInterfaceInfo.setCreationDate(date);
                jcTianyanchaInterfaceInfo.setLastUpdatedBy(-1L);
                jcTianyanchaInterfaceInfo.setLastUpdateDate(date);
...
//        HttpServletRequest request = ((ServletRequestAttributes) RequestContextHolder.getRequestAttributes()).getRequest();
        ...
        this.adMinitor(domainNames);//需要绑定新企业时候执行
