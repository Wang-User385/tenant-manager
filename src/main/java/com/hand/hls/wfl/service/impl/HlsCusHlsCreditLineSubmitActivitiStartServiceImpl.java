...
public class HlsCusHlsCreditLineSubmitActivitiStartServiceImpl implements IActivitiCommonService {
    private static final String workFlowType = "FCT_PROJECTCREATE_WFL";
    @Autowired
    ...
    @Autowired
    private HlsCusHlsCreditLineChanceService hlsCreditLineService;
    ...
    private ProcessInstanceCreateRequest getProcessInstanceCreateRequest(HlsCusHlsCreditLineChance hlsCusHlsCreditLineChance, IRequest iRequest) {
        ...
        restVariable26.setName("projectAssistant2");
        restVariable26.setValue(hlsCusHlsCreditLineChance.getProjectAssistant2());
    ...
    public void cancel(IRequest iRequest, Map params) {
        ...
        hlsCusHlsCreditLine.setChanceId(chanceId);
        hlsCusHlsCreditLine.setCreditLineStatus("CANCEL");
        hlsCusHlsCreditLine = hlsCreditLineService.updateByPrimaryKeySelective(iRequest, hlsCusHlsCreditLine);
    }
}
