...
public class AssetsDisposalRequestActivitiStartServiceImpl implements IActivitiCommonService {

    @Autowired
    private IAssetsDisposalService assetsDisposalService;
    private static final String WORK_FLOW_TYPE = "ASSETS_DISPOSAL_WFL";
    @Autowired
    ...
    public void process(IRequest iRequest, List list, Map params) {
        ...
        assetsDisposal.setAssetsDisposalId(billId);

        assetsDisposal.setProcessInstanceId(Long.valueOf(processInstanceResponse.getId()));
    ...
    public void cancel(IRequest iRequest, Map params) {
        ...
        AssetsDisposal assetsDisposal = new AssetsDisposal();
        assetsDisposal.setAssetsDisposalId(id);
        assetsDisposal.setApprovalStatus(CANCEL_STATUS);
        assetsDisposalService.updateByPrimaryKeySelective(iRequest, assetsDisposal);
    }
}
