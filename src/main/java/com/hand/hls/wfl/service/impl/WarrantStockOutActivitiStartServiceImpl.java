...
public class WarrantStockOutActivitiStartServiceImpl implements IActivitiCommonService {

    private static final String workFlowType = "WARRANT_OUT_STOCK_WFL";
    ...
    private ProcessInstanceCreateRequest getProcessInstanceCreateRequest(HlsWarrantStockHd hlsWarrantStockHd, IRequest iRequest) {
        ...
        ReProcdef reProcdefs = reProcdefService.queryReProcdef(WARRANT_OUT_STOCK_WFL, WARRANT_OUT_STOCK_WFL);
