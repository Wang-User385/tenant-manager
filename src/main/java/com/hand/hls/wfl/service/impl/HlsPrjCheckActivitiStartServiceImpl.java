...
public class HlsPrjCheckActivitiStartServiceImpl implements IActivitiCommonService {
    private static final String workFlowType = "RENT_CHECK_WFL";
    @Autowired
    ...
    public void process(IRequest iRequest, List list, Map params) {
        ...
        //检查上的合同ID是虚拟合同ID  VIRTUAL_CON->PROJECT_ID
        HlsCusPrjProject project = projectMapper.selectByPrimaryKey(prjCheck.getContractId());
        HlsCusBpMaster hlsCusBpMaster = hlsCusBpMasterMapper.selectByPrimaryKey(project.getTenantId());
        String documentName = hlsCusBpMaster.getBpName() + "-租后检查流程";
        params.put(WORK_FLOW_NAME, "RENT_CHECK_WFL");
        params.put(DEMO_NAME, "RENT_CHECK_WFL");
        ...
        params.put("projectAssistant", project.getAssistProjectManager());
    ...
    public void cancel(IRequest iRequest, Map params) {
        ...
        prjCheck = prjCheckService.updateByPrimaryKeySelective(iRequest,prjCheck);
    };
}
