...
public class HlsCshDepositManageHdSubmitActivitiStartServiceImpl implements IActivitiCommonService {
    private static final String workFlowType = "BZJ_DFQZZJ";
    private static final String workFlowTypeDesc = "-保证金代付期中租金-";
    private static final String WORK_FLOW_CATEGORY = "BZJ_DFQZZJ";
    @Autowired
