...
public class HlsCusLonContractWithdrawActivitiStartServiceImpl implements IActivitiCommonService {
    private static final String workFlowType = "LON_CONTRACT_WITHDRAW_WFL";
    @Autowired
    ...
    private ProcessInstanceCreateRequest getProcessInstanceCreateRequest(HlsCusLonContractWithdraw lonContractWithdraw, IRequest iRequest) {
        ...
        ReProcdef reProcdefs = reProcdefService.queryReProcdef("LON_CONTRACT_WITHDRAW_WFL","LON_CONTRACT_WITHDRAW");
        ...
        //查询融资机构名称
        List<HlsCusLonContractWithdraw> withdrawNew = lonContractWithdrawMapper.lonContractWithdrawFormData(lonContractWithdraw);
        ...
        restVariable12.setValue(withdrawNew.get(0).getCreditBpIdN());
        ...
        restVariable14.setValue(lonContractWithdraw.getContractId());
        variables.add(restVariable14);

        RestVariable restVariable0 = new RestVariable();
        restVariable0.setName("BUSINESS_KEY");
        restVariable0.setValue(lonContractWithdraw.getWithdrawId());
