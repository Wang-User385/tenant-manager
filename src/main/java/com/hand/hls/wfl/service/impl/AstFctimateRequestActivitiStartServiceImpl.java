...
public class AstFctimateRequestActivitiStartServiceImpl implements IActivitiCommonService {

    @Autowired
    private IAstFcEstimateService astFcEstimateService;
    private static final String WORK_FLOW_TYPE = "ASSETS_CLASSIFICATION_WFL";
    @Autowired
    ...
    public void cancel(IRequest iRequest, Map params) {
        ...
        astFcEstimate.setRaiseStatus(CANCEL_STATUS);
        astFcEstimateService.updateByPrimaryKeySelective(iRequest, astFcEstimate);
    }
}
