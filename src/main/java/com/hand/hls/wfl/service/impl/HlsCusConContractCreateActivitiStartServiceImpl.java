...
public class HlsCusConContractCreateActivitiStartServiceImpl implements IActivitiCommonService {
    private static final String workFlowType = "CON_CONTRACT_CREATE_WFL";
    @Autowired
    ...
    public void process(IRequest iRequest, List list, Map params) {
        ...
        params.put(WORK_FLOW_NAME, "CON_CONTRACT_CREATE_WFL");
        ...
        params.put("projectName", hlsCusPrjProject.getProjectName());
        params.put("documentName", hlsCusPrjProject.getContractName());
        params.put("documentNumber", hlsCusPrjProject.getContractNumber());
        HlsCusEmployee hlsCusEmployee1 = new HlsCusEmployee();
        hlsCusEmployee1.setEmployeeId(hlsCusPrjProject.getEmployeeId());
        hlsCusEmployee1.setCompanyId(hlsCusPrjProject.getCompanyId());
        params.put("employeeManagerAssignsId", hlsCusEmployeeMapper.selectEmployeeAssignIdByEmployeeId(hlsCusEmployee1).get(0).getEmployeeAssignId());
    ...
    private ProcessInstanceCreateRequest getProcessInstanceCreateRequest(HlsCusPrjProject hlsCusPrjProject, IRequest iRequest) {
        ...
        ReProcdef reProcdefs = reProcdefService.queryReProcdef("CON_CONTRACT_CREATE_WFL", "CON_CONTRACT_CREATE_WFL_SPACE");
        ...
        restVariable16.setValue("CON_CONTRACT_CREATE_WFL");
        ...
        hlsCusEmployee1.setEmployeeId(hlsCusPrjProject.getEmployeeId());
        hlsCusEmployee1.setCompanyId(hlsCusPrjProject.getCompanyId());
        List<HlsCusEmployee> list = hlsCusEmployeeMapper.selectEmployeeAssignIdByEmployeeId(hlsCusEmployee1);
        RestVariable restVariable22 = new RestVariable();
        restVariable22.setName("employeeManagerAssignsId");
        restVariable22.setValue(list.get(0).getEmployeeAssignId());
    ...
    public void cancel(IRequest iRequest, Map params) {
        ...
        hlsCusPrjProject.setContractStatus("NEW");
