 ...
 */
@Service
public class HlsCusFundFillingActivitiStartServiceImpl implements IActivitiCommonService {


    private static final String WORK_FLOW_TYPE = "FUNDING_PLAN_WFL_NEW";
    @Autowired
