 ...
 */
@Service
public class HlsCusFundFillingSummaryActivitiStartServiceImpl implements IActivitiCommonService {


    private static final String WORK_FLOW_TYPE = "FUNDING_PLAN_WFL_NEW_ZJ";
    @Autowired
    ...
    public void cancel(IRequest iRequest, Map params) {
        ...
        filling.setSummaryStatus("REJECTED");
