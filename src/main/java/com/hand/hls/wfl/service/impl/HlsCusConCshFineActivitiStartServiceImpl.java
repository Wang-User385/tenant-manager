...
public class HlsCusConCshFineActivitiStartServiceImpl implements IActivitiCommonService {
    private static final String workFlowType = "CON_CONTRACT_CSH_WFL";
    @Autowired
    ...
    public void process(IRequest iRequest, List list, Map params) {
        ...
        params.put(WORK_FLOW_NAME, "CON_CONTRACT_CSH_WFL");
