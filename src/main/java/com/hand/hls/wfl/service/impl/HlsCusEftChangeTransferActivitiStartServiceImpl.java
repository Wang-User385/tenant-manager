 ...
 * description
 *
 * @author yuanyuan 2019/07/25 9:08 PM
 */
@Service
@Transactional(rollbackFor = Exception.class)
public class HlsCusEftChangeTransferActivitiStartServiceImpl implements IActivitiCommonService {


    private static final String workFlowType =  HlsCusConstant.TRANSFER_WFL.FUND_TRANSFER_CHANGE_WFL;
    ...
    private ProcessInstanceCreateRequest getProcessInstanceCreateRequest(HlsCusFundTransfer fundTransfer, IRequest iRequest) {
        ...
        ReProcdef reProcdefs = reProcdefService.queryReProcdef(HlsCusConstant.TRANSFER_WFL.FUND_TRANSFER_CHANGE_WFL, HlsCusConstant.TRANSFER_WFL.FUND_TRANSFER_CHANGE);
