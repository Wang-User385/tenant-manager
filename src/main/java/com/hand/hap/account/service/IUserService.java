...
public interface IUserService extends IBaseService<User>, ProxySelf<IUserService> {
    ...
    /**
     * 根据Attribute3查询用户.(云之家唯一标识)
     *
     * @param attribute3 用户名称
     * @return 用户
     */
    ...
    List<User> selectUserByEmployeeCode(String employeeCode);
     ...
     * @return 用户集合
     */
    User selectUserNameByUserId(String userId);
     ...
     * @return
     */
    Long selectEmployeeAssginIdByUserId(Long userId);
     ...
     * @param userId
     */
    void reloadUserCacheByUserId(Long userId);


    List<User> queryUsersForLov(IRequest iRequest, User user, int page, int pagesize);
    ...
    /**
     * 根据positionId查询用户的员工信息,并返回userId
     *
     * @param positionId
     * @return
     */
    List<User> selectUserByPositionId(Long positionId);

    User queryUserByAllocationId(String allocationId);
     ...
     * @Return: void
     */
    void updateUserProfile(IRequest iRequest, MultipartFile newProfile);
}
