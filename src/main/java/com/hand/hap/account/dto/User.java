...
public class User extends BaseDTO {
    ...
    public static final String FIELD_INTRANET_FLAG = "intranetFlag";
    ...
    public String getBpNameType() {
        return bpNameType;
    }

    public void setBpNameType(String bpNameType) {
        this.bpNameType = bpNameType;
    }
