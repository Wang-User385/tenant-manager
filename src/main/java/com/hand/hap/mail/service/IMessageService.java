...
public interface IMessageService extends ProxySelf<IMessageService> {
     ...
     * @return 消息列表
     */
    List<Message> selectMessages(IRequest requestContext, Message message, int pageNum, int pageSize);
     ...
     * @throws Exception 消息发送异常
     */
    Message sendMessageWithFileJc(IRequest iRequest, String templateCode, Map<String, Object> templateData,
                        List<MessageReceiver> receivers, List<Long> attachmentIds,List<File> fileList) throws Exception;
     ...
     * @throws Exception 消息发送异常
     */
    Message sendMessageWithFileJc(IRequest iRequest, String accountCode, String subject, String content, String messageType,
                        String sendType, String messageSource, List<MessageReceiver> receivers, List<Long> attachmentIds,List<File> fileList) throws Exception;
